...
W, H, T = 0.65, 1.05, 0.014
R = 0.45  # bend radius around the vertical axis (concave toward the arm, +Y)
...
for p in parts:
    lpm.bend(p, R, axis="z")
boss = lpm.lathe("boss", [(0.0, 0.0), (0.075, 0.0), (0.075, 0.012), (0.055, 0.045), (0.0, 0.065)], segments=10, at=(0, 0, 0), color=P["iron"])
